...
export const aboutMe = [
    ...
    "My favorite projects combine thoughtful user experience with intelligent automation. Recently, I’ve been building <strong>RoutineWise</strong> — a neuro-friendly planner that adapts to user moods and routines using AI, Firebase, and Google Cloud. Whether I’m building microservices, deploying on Kubernetes, or integrating ML models, I’m passionate about delivering software that’s as elegant as it is functional.",
